<?php
	...
	$sql_cate = mysqli_query($con,"SELECT * FROM tbl_category,tbl_sp WHERE tbl_category.cat_Id=tbl_sp.cat_Id AND tbl_sp.cat_Id='$id' ORDER BY tbl_sp.sp_Id DESC  ");
	$sql_category = mysqli_query($con,"SELECT * FROM tbl_category,tbl_sp WHERE tbl_category.cat_Id=tbl_sp.cat_Id AND tbl_sp.cat_Id='$id' ORDER BY tbl_sp.sp_Id DESC  ");
		$row_title = mysqli_fetch_array($sql_category);
		$title = $row_title['cat_Name'];				
				...
				<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="?quanly=chitietsp&id<?php echo $row_sp['sp_Id']?>"><?php echo $row_sp['sp_Name'] ?></a>
											</h4>
