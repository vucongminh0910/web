...
<?php
	...
	$sql_sanpham = mysqli_query($con,"SELECT * FROM tbl_sp WHERE sp_Name LIKE '%$tukhoa%' ORDER BY sp_Id DESC  ");
 ...
 ?>
	...
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">Kết quả cho từ khóa tìm kiếm :<?php echo $title ?></h3>
			<!-- //tittle heading -->
			<div class="row">
				<?php 
				while($row_sp = mysqli_fetch_array($sql_sanpham)){ 
				 ?>
